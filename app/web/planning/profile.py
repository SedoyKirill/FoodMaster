...
#: Белок снижен с 0.25 до 0.20 (решение владельца 29.08.2026): четверть
#: энергии из белка — верхняя граница спортивных рекомендаций, и для двух
#: взрослых это 246 г в день. Недобор относительно такой цели был почти
#: гарантирован, а метрика приёмки protein_gap мерила не питание, а высоту
#: планки. 0.20 даёт тем же двоим 197 г — обычная бытовая норма.
DEFAULT_MACRO_SHARES = {"protein": Decimal("0.20"), "fat": Decimal("0.30"), "carb": Decimal("0.50")}
